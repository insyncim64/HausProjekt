...
import de.jibin.salesrecord.resource.SecondHandRecordResource;

import de.jibin.salesrecord.resource.RoomTypeResource;
...
@EnableWebMvc
@ComponentScan(basePackageClasses = { CommunityTypeResource.class, FirstHandRecordResource.class,
		RoomTypeResource.class, SecondHandRecordResource.class })
@Configuration
...
//		/**
//		 * what is resource chain, GzipResourceResolver, PathResourceResolver?
//		 */
//	}
